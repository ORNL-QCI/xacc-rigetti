...
git clone --recursive https://github.com/ornl-qci/xacc-rigetti
cd xacc-rigetti
...
do
	...
	PYTHONPATH=/xacc/build/lib.linux-x86_64-$ver/xacc $myPython setup.py bdist_wheel --skip-build
        $rpath_python /xacc/tools/wheels/null_rpaths.py -v repair dist/xacc_rigetti-0.1.0-$version-linux_x86_64.whl
done
